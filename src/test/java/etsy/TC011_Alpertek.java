...
public class TC011_Alpertek {
    ...
    public void executeTc011() throws InterruptedException {
        ...
        WebElement vintage = driver.findElement(By.cssSelector("a[href^='https://www.etsy.com/c/vintage']"));
        vintage.click();
        Thread.sleep(3000);
        WebElement shippingOptions = driver.findElement(By.id("ship_to_select"));
        ...
        shippingOptions = driver.findElement(By.id("ship_to_select"));
        ...
        boolean containsCN = driver.getCurrentUrl().contains("ship_to=CN");
